...
export function createFileUploadHandler(
  ...
  setFileInputValue: SetStateAction<string>
) {
...
export function createAvatarRestorer(setFormData: SetStateAction<any>, originalAvatar: string) {
  return () => {
    setFormData((prev: any) => ({ ...prev, avatar: originalAvatar }));
  };
}
